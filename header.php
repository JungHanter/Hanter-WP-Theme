...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="hanter-wordpress-theme">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/js/modernizr-2.8.0.dev.js"></script>
